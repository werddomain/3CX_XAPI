...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxAbandonedChatsStatisticsCollectionResponse {
    /// <summary>
    ...
    public List<PbxAbandonedChatsStatistics> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxAbandonedChatsStatisticsCollectionResponse {\n");
