...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxReceptionistForwardCollectionResponse {
    /// <summary>
    ...
    public List<PbxReceptionistForward> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxReceptionistForwardCollectionResponse {\n");
