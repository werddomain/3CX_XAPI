...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxRingGroupStatisticsCollectionResponse {
    /// <summary>
    ...
    public List<PbxRingGroupStatistics> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxRingGroupStatisticsCollectionResponse {\n");
