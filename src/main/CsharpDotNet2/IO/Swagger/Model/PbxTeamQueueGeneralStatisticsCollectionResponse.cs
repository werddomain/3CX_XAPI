...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxTeamQueueGeneralStatisticsCollectionResponse {
    /// <summary>
    ...
    public List<PbxTeamQueueGeneralStatistics> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxTeamQueueGeneralStatisticsCollectionResponse {\n");
