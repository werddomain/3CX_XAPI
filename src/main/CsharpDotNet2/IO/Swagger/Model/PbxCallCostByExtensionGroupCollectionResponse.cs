...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxCallCostByExtensionGroupCollectionResponse {
    /// <summary>
    ...
    public List<PbxCallCostByExtensionGroup> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxCallCostByExtensionGroupCollectionResponse {\n");
