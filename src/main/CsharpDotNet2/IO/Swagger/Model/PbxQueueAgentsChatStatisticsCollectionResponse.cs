...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxQueueAgentsChatStatisticsCollectionResponse {
    /// <summary>
    ...
    public List<PbxQueueAgentsChatStatistics> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxQueueAgentsChatStatisticsCollectionResponse {\n");
