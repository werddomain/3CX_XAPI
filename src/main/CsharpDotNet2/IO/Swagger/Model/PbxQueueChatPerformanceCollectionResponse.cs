...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxQueueChatPerformanceCollectionResponse {
    /// <summary>
    ...
    public List<PbxQueueChatPerformance> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxQueueChatPerformanceCollectionResponse {\n");
