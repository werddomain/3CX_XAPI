...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxExtensionStatisticsCollectionResponse {
    /// <summary>
    ...
    public List<PbxExtensionStatistics> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxExtensionStatisticsCollectionResponse {\n");
