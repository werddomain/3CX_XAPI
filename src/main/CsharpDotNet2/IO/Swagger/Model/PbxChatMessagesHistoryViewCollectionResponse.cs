...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxChatMessagesHistoryViewCollectionResponse {
    /// <summary>
    ...
    public List<PbxChatMessagesHistoryView> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxChatMessagesHistoryViewCollectionResponse {\n");
