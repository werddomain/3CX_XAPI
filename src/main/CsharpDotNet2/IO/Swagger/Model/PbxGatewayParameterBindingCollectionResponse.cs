...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxGatewayParameterBindingCollectionResponse {
    /// <summary>
    ...
    public List<PbxGatewayParameterBinding> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxGatewayParameterBindingCollectionResponse {\n");
