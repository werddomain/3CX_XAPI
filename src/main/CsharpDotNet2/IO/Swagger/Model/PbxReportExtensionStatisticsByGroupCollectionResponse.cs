...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxReportExtensionStatisticsByGroupCollectionResponse {
    /// <summary>
    ...
    public List<PbxReportExtensionStatisticsByGroup> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxReportExtensionStatisticsByGroupCollectionResponse {\n");
