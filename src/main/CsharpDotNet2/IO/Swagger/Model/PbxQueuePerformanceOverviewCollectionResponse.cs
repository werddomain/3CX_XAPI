...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxQueuePerformanceOverviewCollectionResponse {
    /// <summary>
    ...
    public List<PbxQueuePerformanceOverview> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxQueuePerformanceOverviewCollectionResponse {\n");
