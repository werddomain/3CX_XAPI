...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxExtensionsStatisticsByRingGroupsCollectionResponse {
    /// <summary>
    ...
    public List<PbxExtensionsStatisticsByRingGroups> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxExtensionsStatisticsByRingGroupsCollectionResponse {\n");
