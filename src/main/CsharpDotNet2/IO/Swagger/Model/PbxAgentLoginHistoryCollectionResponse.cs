...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxAgentLoginHistoryCollectionResponse {
    /// <summary>
    ...
    public List<PbxAgentLoginHistory> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxAgentLoginHistoryCollectionResponse {\n");
