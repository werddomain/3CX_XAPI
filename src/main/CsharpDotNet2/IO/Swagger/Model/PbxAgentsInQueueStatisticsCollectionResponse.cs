...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxAgentsInQueueStatisticsCollectionResponse {
    /// <summary>
    ...
    public List<PbxAgentsInQueueStatistics> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxAgentsInQueueStatisticsCollectionResponse {\n");
