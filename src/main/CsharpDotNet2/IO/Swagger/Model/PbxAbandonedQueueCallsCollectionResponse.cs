...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxAbandonedQueueCallsCollectionResponse {
    /// <summary>
    ...
    public List<PbxAbandonedQueueCalls> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxAbandonedQueueCallsCollectionResponse {\n");
