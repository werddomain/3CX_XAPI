...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxQueueFailedCallbacksCollectionResponse {
    /// <summary>
    ...
    public List<PbxQueueFailedCallbacks> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxQueueFailedCallbacksCollectionResponse {\n");
