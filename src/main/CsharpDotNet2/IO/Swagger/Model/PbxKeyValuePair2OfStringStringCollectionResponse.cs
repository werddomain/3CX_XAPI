...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxKeyValuePair2OfStringStringCollectionResponse {
    /// <summary>
    ...
    public List<PbxKeyValuePair2OfStringString> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxKeyValuePair2OfStringStringCollectionResponse {\n");
