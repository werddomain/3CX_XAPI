...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxQueueAgentsChatStatisticsTotalsCollectionResponse {
    /// <summary>
    ...
    public List<PbxQueueAgentsChatStatisticsTotals> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxQueueAgentsChatStatisticsTotalsCollectionResponse {\n");
