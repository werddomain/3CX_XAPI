...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxDetailedQueueStatisticsCollectionResponse {
    /// <summary>
    ...
    public List<PbxDetailedQueueStatistics> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxDetailedQueueStatisticsCollectionResponse {\n");
