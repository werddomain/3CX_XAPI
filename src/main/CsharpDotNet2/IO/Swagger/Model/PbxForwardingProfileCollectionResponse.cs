...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxForwardingProfileCollectionResponse {
    /// <summary>
    ...
    public List<PbxForwardingProfile> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxForwardingProfileCollectionResponse {\n");
