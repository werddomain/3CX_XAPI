...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxFxsVariableChoiceCollectionResponse {
    /// <summary>
    ...
    public List<PbxFxsVariableChoice> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxFxsVariableChoiceCollectionResponse {\n");
