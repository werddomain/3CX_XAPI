...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxQueueAnsweredCallsByWaitTimeCollectionResponse {
    /// <summary>
    ...
    public List<PbxQueueAnsweredCallsByWaitTime> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxQueueAnsweredCallsByWaitTimeCollectionResponse {\n");
