...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxQueuePerformanceTotalsCollectionResponse {
    /// <summary>
    ...
    public List<PbxQueuePerformanceTotals> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxQueuePerformanceTotalsCollectionResponse {\n");
