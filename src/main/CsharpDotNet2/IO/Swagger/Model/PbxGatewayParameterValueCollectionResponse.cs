...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PbxGatewayParameterValueCollectionResponse {
    /// <summary>
    ...
    public List<PbxGatewayParameterValue> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PbxGatewayParameterValueCollectionResponse {\n");
